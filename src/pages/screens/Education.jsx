...
// ICONS
import { MdDownload, MdOutlineLightMode, MdOutlineDarkMode, MdAccessTime, MdLocationOn, MdVerified } from 'react-icons/md';
...
function Education({ darkMode, toggleTheme, handleDownload }) {
    ...
    return (
        <div className={`education-container ${darkMode ? 'dark-theme' : ''}`}>
            ...
            {/* HEADER SECTION */}
            <motion.div
                className={`education-header ${isScrolled ? 'scrolled' : ''}`}
            ...
            >
                <div className="header-left">
                    ...
                    <div className="breadcrumb">
                        ...
                        <span className="current-page">Certifications</span>
                    </div>
                </div>
            ...
            {/* STATS BANNER */}
            <motion.div
                className="education-stats-banner"
            ...
            >
                <div className="stat-item">
                    ...
                    <div className="stat-info">
                        <span className="stat-value">{educationData?.length || 0}</span>
                ...
                <div className="stat-item">
                    ...
                    <div className="stat-info">
                        <span className="stat-value">{certificateData?.length || 0}</span>
            ...
            <div className="certificates-grid-premium">
                {certificateData && certificateData.map((cert, index) => (
                    <CertificateCard
                        key={cert.id}
                        cert={cert}
                        index={index}
